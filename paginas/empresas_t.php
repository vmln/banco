  <!-- inicio barra de menus =========================================-->
                  ...
                  <div class="nav-collapse collapse navbar-responsive-collapse">
                    <ul class="nav">
                      ...
                      <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                          <li class="active"><a href="?menu=t_empresas">TODAS</a></li>
     ...
     <!-- Migas de pan -->
          <ul class="breadcrumb">
            ...
            <li class="active">TODAS LAS EMPRESAS<span class="divider">/</span></li>
         </ul>
<!-- consulta a la base de datos para obtener información -->
  <h3 class="titulo_pagina"> Todas las Empresas</h3>
  <div class="hero-unit">
