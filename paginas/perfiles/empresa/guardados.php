...
<div class="row-fluid">
	<div class="span12">
		...
		<div class="span6">
			...
			<button class="btn btn-primary"><a style="color:white;" href="?menu_em=proyectosSave">Regresar</a></button>
			<button class="btn btn-primary"><a style="color:white;" href="?menu_em=editar_proyecto">Editar</a></button>
			<button class="btn btn-primary"><a style="color:white;" href="?menu_em=proyectos Todos">Descartar</a></button>
		</div>
	</div>
</div>
