...
<section>
	<?php
		$p=mysql_query("
			select *
			FROM proyecto
			WHERE id_usuario=".$_SESSION["id_usuario"]." and p_estatus='Guardado'
			")or die(mysql_error());
		...
		<div class="row-fluid" align="center">
			<div class="span12" style="border:1px #C2B9B9 solid">
				...
				<div class="span3">
					<button class="btn btn-primary"><a style="color:white;" href="?menu_em=guardados&id=<?php  echo $proyecto['id_proyecto'];?>">Ver Proyecto</a></button>
				</div>
			</div><br>
		</div>
	<?php
