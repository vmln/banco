<!-- Migas de pan -->
  <ul class="breadcrumb">
    ...
    <li><a href="?menu_res=Empresas new">SOLICITUDES</a> <span class="divider">/</span></li>
...
<div class="detalles_cont">
	<div class="row-fluid">
		<legend>Detalles de la empresa: <span><?php echo $usuario['emp_nombre'];?></span></legend>
		<div class="span12">
			...
			<div class="span6" style="font-size:18px;">
				...
				<span><?php echo $usuario['correo'];?></span><br><br>
				<strong>Estatus: </strong>
				<span><?php echo $usuario['estatus'];?></span><br><br>

				<a class="btn btn-primary" style="color:white;" href="?menu_res=Empresas new">Regresar</a>
			</div>
		</div>
	</div>
</div>
